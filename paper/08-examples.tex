...
mode of the kernel, the mean of the stable kernels being infinite (\emph{ibid.}, p.~102).
...
In the parabolic gauge $\xi$ of Remark~\ref{rem:gauge-freedom}, $\tilde x = \xi^2/2$, these
...
Proposition~\ref{prop:moments} no stable member has a mean. Any other nonincreasing $k$ is
