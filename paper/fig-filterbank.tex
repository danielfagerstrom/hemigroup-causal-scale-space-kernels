...
\draw[->] (0.4,0) -- (0.85,0);
\node[sect] (d0) at (1.75,0) {delay $b_0\Delta x$};
\node[sect] (t1) at (4.25,0) {$w_1$ sections, $\tau_1$};
\node[sect] (t2) at (6.95,0) {$w_2$ sections, $\tau_2$};
\draw[->] (d0) -- (t1);
\draw[->] (t1) -- (t2);
\draw[->] (t2) -- (8.45,0);
\node[anchor=west] at (8.5,0) {$\cdots$};
\node[sect] (tN) at (10.25,0) {$w_N$ sections, $\tau_N$};
\draw[->] (9.15,0) -- (tN);
\draw[->] (tN) -- (11.75,0);
\node[anchor=west] at (11.75,0) {$u_{k+1}$};
...
the Thorin measure, led by the drift's pure time shift: the Thorin sum lives in the
