...
gauge every exponent is a dilate of a single function $F$.
...
makes that an identity of measures; this is the first equivalence. For the second,
...
bijection of $[0,\infty)$ fixes $0$; $G$ is $g_{0,\cdot}$ by Lemma~\ref{lem:additivity}.
\end{proof}
...
in which $\Sact_\sigma$ acts by multiplication, scale carries the dimension of time, and
$G(x,s) = F(\tilde x\, s)$.
