...
spent: $\|T_rf-f\|_1 \le r\|f'\|_1$ makes the integrand small at the origin, while
$\|T_rf-f\|_1 \le 2\|f\|_1$ holds for every $f \in X$, so the core hypothesis buys only the first
