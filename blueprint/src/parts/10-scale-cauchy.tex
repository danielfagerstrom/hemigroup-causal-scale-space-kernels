...
\end{enumerate}
\statusT\quad\emph{(\textbf{Stated in Lean, unproved} (2026-08-14):
\texttt{Skeleton/Chapter10.lean} carries the five clauses as named sub-lemmas with a
\texttt{sorry}-free collation above them, which is the decomposition gate's middle state and not a
claim. \textbf{Not blocked by generation theory}: no clause mentions a generator's domain, a
