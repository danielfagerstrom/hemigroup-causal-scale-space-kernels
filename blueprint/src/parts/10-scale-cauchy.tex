...
\end{enumerate}
\statusT\quad\emph{(\textbf{Stated in Lean, clause (1) proved} (2026-08-14):
\texttt{Skeleton/Chapter10.lean} carries the open clauses as named sub-lemmas with a
\texttt{sorry}-free collation above them, which is the decomposition gate's middle state and not a
claim; clause (1) has moved into \texttt{Hemigroup/PhillipsGenerator.lean} and is Lean core, the
statements quantifying over any $\nu_1$ meeting the tail specification rather than over the
constructed family. \textbf{The convergence
